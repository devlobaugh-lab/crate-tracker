 ...
 * @param {Function} setIgnoreRemoteChanges - Function to set ignore remote changes state
 * @returns {Function} Function to set ignore with timeout
 */
export function useIgnoreRemoteChanges(setIgnoreRemoteChanges) {
